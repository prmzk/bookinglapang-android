...
import com.example.keviniswara.bookinglapangtest.databinding.ActivityMainBinding
import com.example.keviniswara.bookinglapangtest.user.home.view.HomeFragment
import com.example.keviniswara.bookinglapangtest.user.order.view.OrderFragment
import com.example.keviniswara.bookinglapangtest.user.profile.view.ProfileFragment
import com.example.keviniswara.bookinglapangtest.user.status.view.StatusFragment
import android.util.TypedValue
import android.support.design.internal.BottomNavigationMenuView
import android.support.v7.widget.Toolbar
import android.view.View
import com.example.keviniswara.bookinglapangtest.utils.BottomNavigationViewHelper
